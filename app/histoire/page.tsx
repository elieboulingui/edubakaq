        ...
        <>
            ...
            <Modal isOpen={isNomenclatureVisible} onClose={() => setIsNomenclatureVisible(false)} title="📊 Nomenclature Ethnique">
                <div>
                    ...
                    <div className="bg-purple-100 p-4 rounded-lg border-l-4 border-l-purple-700">
                        <p className="text-base font-bold text-gray-900 mb-2">ℹ️ À propos de cette nomenclature</p>
                        <p className="text-sm leading-5 text-gray-900">Cette nomenclature a été établie en hommage à Brigitte Ebengue (2015).</p>
                    </div>
                </div>
            </Modal>
