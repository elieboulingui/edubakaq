...
export default function DictionnaireBaka() {
  ...
  { francais: "bois", baka: "KOLO", phonetique: "kɔlɔ" },
  ...
  // C
  { francais: "ça", baka: "Na nguè", phonetique: "na ngɛ" },
  { francais: "cacher", baka: "worwor", phonetique: "wɔrwɔr" },
  { francais: "carpe", baka: "toko", phonetique: "tɔkɔ" },
  { francais: "carri", baka: "Ngiangalé", phonetique: "ŋgiaŋgalɛ" },
  ...
  { francais: "celle ci/celle là", baka: "boko", phonetique: "bɔkɔ" },
  ...
  { francais: "dimanche", baka: "DOWOZO", phonetique: "dɔwɔzɔ" },
  ...
  // S { "francais": "oiseau", "baka": "nou", "phonetique": "nu" },
    { "francais": "malade", "baka": "fere", "phonetique": "keke" },
    { "francais": "malade (forme abrégée)", "baka": "MA", "phonetique": "ma" },
    { "francais": "manège", "baka": "gabbo", "phonetique": "gabbo" },
    { "francais": "son", "baka": "banda", "phonetique": "bada" },
    { "francais": "soigner (faveur médicalement)", "baka": "mema", "phonetique": "mema" },
    { "francais": "son (garder un malade)", "baka": "banda", "phonetique": "banda" },
    { "francais": "prendre son", "baka": "bano", "phonetique": "bana" },
    { "francais": "dresser", "baka": "wosolo", "phonetique": "wosolo" },
    { "francais": "serpent mythique", "baka": "joni", "phonetique": "jsi" },
    ...
    { "francais": "sans bouger", "baka": "nkoba", "phonetique": "nkɔba" },
    ...
    { "francais": "sept serpents", "baka": "aduvitto latton", "phonetique": "aduvitɔ latɔn" },
    { "francais": "serpent mythique", "baka": "jonli", "phonetique": "dʒɔnli" },
    { "francais": "serre", "baka": "le", "phonetique": "lɛ" },
    { "francais": "se coucher", "baka": "la", "phonetique": "la" },
    { "francais": "se reposer", "baka": "jete", "phonetique": "dʒɛtɛ" },
    { "francais": "sexe (femme)", "baka": "AZOWOCE", "phonetique": "azɔwɔsɛ" },
    { "francais": "sexe (homme)", "baka": "NZOBOU", "phonetique": "nzɔbu" },
    { "francais": "sexe (nyon)", "baka": "NYORBO", "phonetique": "ɲɔrbɔ" },
    { "francais": "soif", "baka": "gogomu", "phonetique": "gɔgɔmu" },
    { "francais": "soigner", "baka": "polo", "phonetique": "pɔlɔ" },
    { "francais": "soigner (avec médicament)", "baka": "même", "phonetique": "mɛmɛ" },
    { "francais": "sol", "baka": "tolo", "phonetique": "tɔlɔ" },
    { "francais": "solaire", "baka": "mbako", "phonetique": "mbakɔ" },
    { "francais": "solide", "baka": "ndedzeze", "phonetique": "ndɛdzɛzɛ" },
    { "francais": "son ami", "baka": "e loût", "phonetique": "ɛ lut" },
    { "francais": "soulette", "baka": "tâw tanwoulo", "phonetique": "taw tanwulɔ" },
    { "francais": "soleil", "baka": "mbako", "phonetique": "mbakɔ" },
    { "francais": "seul", "baka": "kole pode", "phonetique": "kɔlɛ pɔdɛ" },
  ...
  { francais: "tête (femme)", baka: "GOZA", phonetique: "gɔza" },
  { francais: "tête (homme)", baka: "DOZA", phonetique: "dɔza" },
